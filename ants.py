...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        stepcount = 0
        antbee_check = self.place
        while antbee_check != beehive:
            if antbee_check.bees == []:
                antbee_check = antbee_check.entrance
                stepcount += 1

            if self.min_range == 5 and stepcount == 4:
                antbee_check = antbee_check.entrance
                stepcount += 1
            if antbee_check.bees != [] and antbee_check == beehive:
                return None
            if antbee_check.bees != []:
                if stepcount > self.max_range or stepcount < self.min_range:
                    return None
                return random_or_none(antbee_check.bees)
        # REPLACE THIS LINE
        # END Problem 3 and 4
    ...
    def action(self, gamestate):
        ...
        if self.digests:
            ...
            if random_or_none(self.place.bees):
                ...
                self.digests = self.time_to_digest
...
class ContainerAnt(Ant):
    ...
    def can_contain(self, other):
        # BEGIN Problem 9
        #ant doesn't contain another ant, is a container, other ant is not a container
    ...
    #        Ant.action(self.contained_ant, gamestate)
        # END Problem 9
...
# END Problem 13
    ...
    def __init__(self, armor=1):
        # BEGIN Problem 13
        #Insect.reduce_armor(self.armor)
        #Insect.reduce_armor(self, amount)
        ScubaThrower.__init__(self, armor)
        if QueenAnt.already_called == False:
            QueenAnt.already_called = True
            self.truequeen = True
        else:
    ...
    def action(self, gamestate):
        ...
        if not self.truequeen:
            ...
            tunnel_position = self.place.exit
            while tunnel_position != None:
                if isinstance(tunnel_position.ant, ContainerAnt) and tunnel_position.ant.contained_ant and tunnel_position.ant.contained_ant.damaged == False:
                        tunnel_position.ant.contained_ant.damage *= 2
                        tunnel_position.ant.contained_ant.damaged = True

                        #print(tunnel_position.ant.contained_ant.damage)
                        #self.damaged = True
                if tunnel_position.ant and tunnel_position.ant.damaged == False:
                    tunnel_position.ant.damaged = True
                    tunnel_position.ant.damage *=  2
                tunnel_position = tunnel_position.exit
    ...
    def reduce_armor(self, amount):
        ...
        # BEGIN Problem 13
        Insect.reduce_armor(self, amount)
        if self.truequeen and self.armor == 0:
            bees_win()
        # END Problem 13
